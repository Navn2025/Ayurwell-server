        ...
        await prisma.$transaction(async (tx) =>
        {
            ...
            await tx.orderStatusHistory.create({
                data: {
                    orderId: order.id,
                    status: "REFUNDED",
                    note: `RTO refund of ₹${order.totalAmount/100} initiated`,
                },
            });
        });
        ...
        await prisma.$transaction(async (tx) =>
        {
            ...
            await tx.orderStatusHistory.create({
                data: {
                    orderId: order.id,
                    status: "REFUNDED",
                    note: `Customer return refund of ₹${order.totalAmount/100} initiated`,
                },
            });
        });
        ...
        await prisma.$transaction(async (tx) =>
        {
            ...
            await tx.orderStatusHistory.create({
                data: {
                    orderId: order.id,
                    status: "REFUNDED",
                    note: `Admin refund: ${reason}. Amount: ₹${order.totalAmount/100}`,
                },
            });
        });
        ...
        await prisma.$transaction(async (tx) =>
        {
            ...
            await tx.orderStatusHistory.create({
                data: {
                    ...
                    status: "REFUNDED",
                    note: `Refund of ₹${refund.amount/100} completed successfully`,
                },
            });
        });
